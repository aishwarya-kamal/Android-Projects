 ...
 */
public class TechnologyFragment extends Fragment implements android.support.v4.app.LoaderManager.LoaderCallbacks<List<Newspaper>> {

    /*
    *  This is NINO CODE PLEASE DONT DELETE IT ...
    */
    private static final String NEWS_URL =
            "https://newsapi.org/v1/articles?source=the-verge&sortBy=latest&apiKey=83dbe5057f1e4920a636cdfe06502b36";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            loaderManager.initLoader(LOADER_ID, null, TechnologyFragment.this);
        } else {
