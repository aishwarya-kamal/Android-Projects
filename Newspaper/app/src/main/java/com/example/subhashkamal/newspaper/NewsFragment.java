 ...
 */
public class NewsFragment extends Fragment implements android.support.v4.app.LoaderManager.LoaderCallbacks<List<Newspaper>>{

    /*
     *  This is NINO CODE PLEASE DONT DELETE IT ...
     */
    private static final String NEWS_URL =
            "https://newsapi.org/v1/articles?source=al-jazeera-english&sortBy=latest&apiKey=83dbe5057f1e4920a636cdfe06502b36";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            loaderManager.initLoader(LOADER_ID, null, NewsFragment.this);
        } else {
    ...
    public Loader<List<Newspaper>> onCreateLoader(int id, Bundle args) {
        // Create a new loader for the given URL
        return new NewspaperLoader(this, NEWS_URL);
    }


    @Override
    public void onLoadFinished(android.content.Loader<List<Newspaper>> loader, List<Newspaper> news) {
    ...
    @Override
    public void onLoaderReset(android.content.Loader<List<Newspaper>> loader) {
        // Loader reset, so we can clear out our existing data.
        mAdapter.clear();
    }
     */
