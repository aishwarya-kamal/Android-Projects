 ...
 */
public class ScienceFragment extends Fragment implements android.support.v4.app.LoaderManager.LoaderCallbacks<List<Newspaper>>{

    /*
    *  This is NINO CODE PLEASE DONT DELETE IT ...
    */
    private static final String NEWS_URL =
            "https://newsapi.org/v1/articles?source=national-geographic&sortBy=top&apiKey=d1d394d29cef4cf1b0481dbdc0e947ee";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            loaderManager.initLoader(LOADER_ID, null, ScienceFragment.this);
        } else {
